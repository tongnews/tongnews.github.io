...
//    });
    ...
    $('.user_login_enter').click(function () {
         $(".sginbox").attr("style","width:0px; height:0px; border:none; overflow:hidden;");
         $(".loginbox").attr("style","");
    ...
    $('.user_back').click(function () {
         $(".sginbox").attr("style","width:0px; border:none; height:0px; overflow:hidden;");
         $(".loginbox").attr("style","width:0px; border:none; height:0px; overflow:hidden;");
