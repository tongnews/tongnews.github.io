...
function baseJSload(){
    ...
    $('body').append('<div class="footer-bottom"><div class="inner-footer"><div id="footer-left"><div class="left">© 2015 痛新闻网站制作组<a href="about.html">关于我们</a><a class="sitemap_download">网站地图</a></div><a href="about.html" class="footerCopyright">Designed by 小T酱</a></div><div class="clear"></div></div></div>');
